...
export let typed: MethodDecorator = decorate(decMethod('value', (fn: Function, [from, to]: [Type<any>[], Type<any>]) => function() {
...
export let fallback: MethodDecorator = decorate(decMethod('value', <T, TFunction extends () => T>(fn: TFunction, [def]: [T], meta: DecoratorMeta<TFunction>) => function() {
  try {
    return callFn(fn, this, arguments);
  }
  catch(e) {
...
export let try_log: MethodDecorator = decorate(decMethod('value', <T, TFunction extends () => T>(fn: TFunction, [], meta: DecoratorMeta<TFunction>) => function() {
  try {
    return callFn(fn, this, arguments);
  }
  catch(e) {
...
export let combine: MethodDecorator = decorate(decMethod('value', (fn: Function, [allow_undef]: [Obj<boolean>]) => function() {
